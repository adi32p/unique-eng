...
const timeline = [
  {
    year: "2009",
    title: "Foundation",
    description: "Unique.EP was founded with a vision to provide comprehensive environmental solutions.",
  },
  {
    year: "2012",
    title: "PAN-India Expansion",
    description: "Expanded operations to cover all states of India with regional offices.",
  },
  {
    year: "2015",
  ...
  },
  {
    year: "2018",
    title: "1000+ Projects",
    description: "Crossed the milestone of 1000 successfully completed projects.",
  },
  {
    year: "2021",
...
const whyChooseUs = [
  {
    ...
    description: "Deep expertise in environmental regulations and compliance requirements.",
  },
  {
    icon: Globe,
    title: "PAN-India Presence",
    description: "Operational across all 28 states with local regulatory knowledge.",
  },
  {
    icon: Users,
    title: "Expert Team",
  ...
  },
  {
    ...
    description: "Dedicated project managers and 24/7 support for critical projects.",
  },
  {
    icon: Leaf,
    title: "Sustainability Focus",
    description: "Committed to sustainable development and environmental protection.",
  },
];
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          >
            ...
            <br />
            <span className="text-leaf-light">Excellence Since 2009</span>
          </motion.h1>
          ...
          >
            India's trusted partner for environmental clearance, compliance management,
          ...
          <Card className="h-full bg-gradient-to-br from-leaf/5 to-transparent border-leaf/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                solutions that enable our clients to achieve regulatory compliance
                while contributing to sustainable development. We strive to be the
                bridge between industrial growth and environmental protection.
              </p>
            </CardContent>
          </Card>
        </AnimatedSection>
          ...
          <Card className="h-full bg-gradient-to-br from-sky/5 to-transparent border-sky/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                industry standards for excellence, innovation, and sustainability.
                We envision a future where every business operates in harmony
                with the environment, creating lasting value for generations.
              </p>
            </CardContent>
          </Card>
        </AnimatedSection>
        ...
        {teamMembers.map((member) => (
          <StaggerItem key={member.id}>
            <Card className="h-full overflow-hidden group">
              <div className="aspect-square relative bg-gradient-to-br from-leaf/20 to-sky/20">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-forest flex items-center justify-center text-white text-3xl font-display font-bold">
